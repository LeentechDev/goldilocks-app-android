  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        ...
        print("asddsdadas "+CustomTrace(StackTrace.current, message: this.paymentMethod.name).toString());
      },
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
           ...
           boxShadow: [
            BoxShadow(color: Theme.of(context).dividerColor.withOpacity(0.1), spreadRadius: 5, blurRadius: 5, offset: Offset(0, 2)),
           ],
          ),
          child: Row(
