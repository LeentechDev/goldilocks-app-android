...
class LocationPageController extends ControllerMVC with ChangeNotifier {
  ...
  void addAddress(model.Address address) {
    userRepo.addAddress(address).then((value) {
      ...
      scaffoldKey?.currentState?.showSnackBar(SnackBar(
        content: AutoSizeText(S.of(context).new_address_added_successfully),
      ));
    });
  }
  ...
  void removeDeliveryAddress(model.Address address) async {
    userRepo.removeDeliveryAddress(address).then((value) {
      ...
      scaffoldKey?.currentState?.showSnackBar(SnackBar(
        content: AutoSizeText(S.of(context).delivery_address_removed_successfully),
      ));
    });
  }
}
