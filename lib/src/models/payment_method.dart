...
class PaymentMethodList {
  ...
  PaymentMethodList(BuildContext _context) {
    this._paymentsList = [
          new PaymentMethod("stripe", S.of(_context).stripe, S.of(_context).stripe_contains, "/Checkout", "assets/img/stripe.png", isDefault: true),
    ...
    this._pickupList = [
      new PaymentMethod("pop", S.of(_context).store_pick_up, S.of(_context).click_to_select_store_pick_up, "/PaymentMethod", "assets/img/pay_pickup.png"),
      new PaymentMethod("delivery", S.of(_context).delivery_address, S.of(_context).click_to_confirm_your_address_and_pay_or_long_press, "/PaymentMethod", "assets/img/pay_pickup.png"),
    ];
  }
