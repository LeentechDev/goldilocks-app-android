...
import 'package:food_delivery_app/src/controllers/postmates_controller.dart';
...
class PostmatesWidget extends StatefulWidget {
  RouteArgument routeArgument;
  PostmatesWidget({Key key, this.routeArgument}) : super(key: key);
  @override
  _PostmatesWidgetState createState() => _PostmatesWidgetState();
}

class _PostmatesWidgetState extends StateMVC<PostmatesWidget> {
  PostmatesController _con;
  _PostmatesWidgetState() : super(PostmatesController()) {
    _con = controller;
  }
  @override
