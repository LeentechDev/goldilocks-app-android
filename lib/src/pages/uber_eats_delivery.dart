...
import 'package:food_delivery_app/src/controllers/uber_eats_controller.dart';
...
class UberEatsWidget extends StatefulWidget {
  RouteArgument routeArgument;
  UberEatsWidget({Key key, this.routeArgument}) : super(key: key);
  @override
  _UberEatsWidgetState createState() => _UberEatsWidgetState();
}

class _UberEatsWidgetState extends StateMVC<UberEatsWidget> {
  UberEatsController _con;
  _UberEatsWidgetState() : super(UberEatsController()) {
    _con = controller;
  }
  @override
