                      ...
                      children: <Widget>[
                                ...
                                SizedBox(
                                  ...
                                  child: Chip(
                                    ...
                                    label: Row(
                                      ...
                                      children: <Widget>[
                                        AutoSizeText(_con.order.foodOrders[0].food.restaurant.rate,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              AutoSizeText(S.of(context).how_would_you_rate_this_store_,
                          ...
                          children: List.generate(_con.foodsOfOrder.length, (index) {
                            return Container(
                              ...
                              child: Column(
                                ...
                                mainAxisSize: MainAxisSize.max,
                                children: <Widget>[
                                  AutoSizeText(_con.foodsOfOrder[index].name, textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1),
                                  SizedBox(height: 10),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
