        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  items: [
                    DropdownMenuItem(
                      ...
                      child: SizedBox(
                        ...
                        child: AutoSizeText('(+213) - Algeria', textAlign: TextAlign.center),
                      ),
                    ),
                    DropdownMenuItem(
                      value: '+216',
                      child: SizedBox(
                        width: _ac.appWidth(70), // for example
                        child: AutoSizeText('(+216) - Tunisia', textAlign: TextAlign.center),
                      ),
                    ),
                  ],
                ),
            ...
            new BlockButtonWidget(
              ...
              text: AutoSizeText(S.of(context).submit.toUpperCase(),
