...
import 'package:food_delivery_app/src/controllers/grubhub_controller.dart';
...
class GrubhubWidget extends StatefulWidget {
  RouteArgument routeArgument;
  GrubhubWidget({Key key, this.routeArgument}) : super(key: key);
  @override
  _GrubhubWidgetState createState() => _GrubhubWidgetState();
}

class _GrubhubWidgetState extends StateMVC<GrubhubWidget> {
  GrubhubController _con;
  _GrubhubWidgetState() : super(GrubhubController()) {
    _con = controller;
  }
  @override
